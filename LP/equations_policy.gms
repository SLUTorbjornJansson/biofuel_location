...
* Restricting production to be within tech_eq bounds
...
*v_EFeedstock(f_eq,b_fuel,tech_eq,i,g)  =e=  v_feedstock.l(f_eq,b_fuel,tech_eq,i,g) * sum(lan$lan_to_kn(lan,g),ghg_factor(f_eq,"feedstock",lan));
...
*eq_totEmissions..
*v_totEmissions =e=
*sum((f_eq,b_fuel,tech_eq,g),v_EFeedstock(f_eq,b_fuel,tech_eq,i,g)+ v_ELUC(f_eq,b_fuel,tech_eq, i,g)+v_ETransport(f_eq,b_fuel,tech_eq,i,g))
*                  + sum((b_fuel,tech_eq,i), v_EProduction(b_fuel,tech_eq,i))
*+v_EInvestment(b_fuel,tech_eq,i))
*                  + sum((b_fuel,tech_eq,h), v_EDistribution(b_fuel,tech_eq,i,h))
*                  + sum((b_fuel, tech_eq,h), v_EFossilSubs(b_fuel,tech_eq,i,h)))
...
parameter location_subsidy(b_fuel,tech_eq,i)'subsidy based on the need to fix location';
emis_tax = 0;
location_subsidy(b_fuel,tech_eq,i) = 0;
...
- sum((b_fuel, tech_eq,i),location_subsidy(b_fuel,tech_eq,i) *J(b_fuel,tech_eq,i)) $ p_policy;
;
