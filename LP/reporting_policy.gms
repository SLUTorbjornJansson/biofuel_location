...
*execute_loadpoint 'm_locatepolicy_p';

* Calculate more reporting
* ---------------------------------

p_solveInfo("solveStat") = m_locatepolicy.solvestat;
p_solveInfo("modelStat") = m_locatepolicy.modelstat;
p_solveInfo("iterUsd") = m_locatepolicy.iterusd;
p_solveInfo("resUsd") = m_locatepolicy.resusd;
p_solveInfo("numInfes") = m_locatepolicy.Numinfes;
p_solveInfo("objval") = m_locatepolicy.objval;
p_solveInfo("objEst") = m_locatepolicy.objEst;
...
parameter tax_rev(*);
tax_rev("tax")= -(emis_tax * (v_totEmissions.l + ghg_factor("all","gasoline","all") * sum(h, fuelUse_0_Tm3(h,"gas"))
            + ghg_factor("all","diesel","all") * sum(h, fuelUse_0_Tm3(h,"die"))));
tax_rev("obj less tax")=v_tot_cost.l-tax_rev("tax");
tax_rev("subs") = - sum((b_fuel, tech,i),location_subsidy(b_fuel,tech,i) *J.l(b_fuel,tech,i));
tax_rev("obj less tax and subs") = tax_rev("obj less tax")-v_tot_cost.l-tax_rev("tax")- tax_rev("subs");
