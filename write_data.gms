...
* Hectares of ALA per county, old cropland
$if not exist data\ALA_municiaplity_O_and_B_2016.gdx $call 'gdxxrw data\ALA_municiaplity_O_and_B_2016.xlsx output=data\ALA_municiaplity_O_and_B_2016.gdx par=ALA_crop rng=A2 ignoreColumns=B,C,D,E,F,G,H,I,J,K,L,M,N,O,P rDim=1'
