...
ghg_factor("ab1","LUC",g)= ghg_factor("ab1","LUCabovecrp",g) + ghg_factor(ab,"SOCcrp",g);
ghg_factor("ab2","LUC",g)= (ghg_factor("ab2","LUCabovecrp",g) + ghg_factor("ab3","LUCabovenat",g) + ghg_factor(ab,"SOCcrp",g)) /2;
ghg_factor("ab3","LUC",g)= ghg_factor("ab3","LUCabovenat",g) + 0;
...
* Reset LUC values
ghg_factor(ab,"LUC",g)= ghg_factor(ab,"LUCabovecrp",g);
