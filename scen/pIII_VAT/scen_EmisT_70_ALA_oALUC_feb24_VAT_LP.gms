...
$setglobal scen _crpALA_onlyArableLUC_feb24_VAT
...
ghg_factor(grass,"LUC",g)= ghg_factor("ab1","LUCabovecrp",g) +  ghg_factor("ab1","SOCcrp",g);
...
p_J(b_fuel, tech, i)$(p_J(b_fuel, tech, i)<0.98) = 0 ;
