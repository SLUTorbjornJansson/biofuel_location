...
$setglobal scen _crpALA_CEAsLey_feb24_VAT
...
* Assume same lUC as for ley - 0 t co2
ghg_factor(ab,"LUC",g)= 0;

* Feedstock costs as ley category 3
cost_feedstock(ab,g)= cost_feedstock("grass3",g);
