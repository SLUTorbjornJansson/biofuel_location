...
$setglobal scen _crpALA_highLUC_both_feb24_VAT
...
* Redefine LUC emissions: assume half of previous
ghg_factor(ab,"LUC",g)= 1.5 *(ghg_factor(ab,"LUCabovecrp",g) +  ghg_factor(ab,"SOCcrp",g));

* In paper 4 specification, p_0 is reduced. here, we keep original p_0, ie. p_bioTax=0
biotax("ethanol")= 0;
