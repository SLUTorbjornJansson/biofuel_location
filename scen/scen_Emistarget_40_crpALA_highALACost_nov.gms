...
$setglobal scen _crpALA_highProdCost_28nov
...
* Double feedstock costs for ALA

cost_feedstock(ab,g)= 2 * cost_feedstock(ab,g);
...
cost_feedstock(ab,g)= cost_feedstock(ab,g) / 2;
